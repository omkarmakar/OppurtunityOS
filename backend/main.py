...
from backend.api.v1.endpoints.user_preferences import router as user_preferences_router
...
app.include_router(user_preferences_router, prefix="/api/v1", tags=["user_preferences"])
